...
namespace WebApplicationDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var policy = new AuthorizationPolicyBuilder().RequireAuthenticatedUser().Build(); //kullanýcýn yetkili olmasý için
                config.Filters.Add(new AuthorizeFilter(policy)); //tüm proje yetkili giriþi istiyor
            });
